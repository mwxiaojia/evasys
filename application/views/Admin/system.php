		<div class="content-inner">
			...
			<section class="form">
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
							<form class="form-horizontal" method="post" action="<?php echo site_url('/admin/system/search'); ?>">
												...
												<?php foreach ($systems as $n => $s): ?>
													<tr>
														...
														<td>
															...
															<a onclick='if(window.confirm("确认要删除吗？")){window.location.href = "<?php echo site_url('/admin/system/del?id=') . $s['id']; ?>";}' title="删除"><i class="fa fa-trash-o"></i>&nbsp;删除</a>
