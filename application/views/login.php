							...
							<div class="form d-flex align-items-center">
								<div class="content">
									<ul class="nav nav-tabs nav-justified">
										<div
											class="border-left border-right align-items-center nav nav-tabs nav-justified">
											<li id="expert" value="1">
												<a href="#">
													审核专家
												</a>
											</li>
											<li>&ensp;&ensp;</li>
											<div class="align-items-center nav nav-tabs nav-justified float-left ">
												<li id="umanager" value="2">
													<a href="#">
														校级管理员
													</a>
												</li>
									...
									<form method="post" class="form-validate">
										<div class="form-group">
											...
											<label for="login-username" class="label-material">用户名User Name</label>
										</div>
										<div class="form-group">
											<input id="login-password" type="password" name="loginPassword" required
												   data-msg="Please enter your password" class="input-material">
											<label for="login-password" class="label-material">密码Password</label>
										</div>
										<a id="login" href="index.html" class="btn btn-primary">登录Login</a>
										<!-- This should be submit button but I replaced it with <a> for demo purposes-->
									</form>
									<a href="#" class="forgot-pass">忘记密码Forgot Password?</a><br><small>没有帐户Do
									not have an account? </small><a href="register.html" class="signup">注册Signup</a>
								</div>
							</div>
						</div>
					</div>
